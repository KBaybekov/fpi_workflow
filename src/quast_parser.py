...
def parse_args(args:list):
    if len(args) != 4:
        print("Использование: quast_parser.py sample_id, busco.json busco_qc_data.xlsx")
        sys.exit(1)
...
def main():
    ...
    id, quast_report, qc_data_file = parse_args(sys.argv)
    ...
    data = get_quast_data(id=id, quast_report=quast_report, cols=quast_cols)
